...
class AlumnadoConvivenciaScreen extends StatelessWidget {
  const AlumnadoConvivenciaScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          const BackGround(),
          AlumnadoConvivencia(userLogin: userLogin)
        ]
      ) ,
...
class AlumnadoConvivencia extends StatelessWidget {
  const AlumnadoConvivencia({super.key, required this.userLogin});
      ...
      children: [
        ...
        Expanded(
          child: SizedBox(
            ...
            child: ListView(
              children: [
                ...usersProvider.listConvivencia.map((user) {
